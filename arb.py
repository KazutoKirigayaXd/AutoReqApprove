#ARB means Auto Request Bot 
#ARB SN means Auto Request Bot of Supreme Network
...
app = Client("ARB SN", api_id=config.API_ID, api_hash=config.API_HASH, bot_token=config.BOT_TOKEN)

welcome=[
    "https://telegra.ph/file/e6299d404bb6397a73600.jpg",
]
...
async def start(app: Client, msg: Message):
    if config.FSUB:
        ...
        await msg.reply_photo(
            photo="https://telegra.ph/file/e6299d404bb6397a73600.jpg",
            caption=f"Hᴇʟʟᴏ {msg.from_user.mention}💞,\n\n☉︎ Tʜɪs Is {app.me.mention},\n\n➲ A Tᴇʟᴇɢʀᴀᴍ Bᴏᴛ Mᴀᴅᴇ Fᴏʀ Aᴜᴛᴏ Aᴘᴘʀᴏᴠɪɴɢ Jᴏɪɴ Rᴇǫᴜᴇsᴛ Iɴ Gʀᴏᴜᴘ/Cʜᴀɴɴᴇʟ.\n\n➲ Jᴜsᴛ Aᴅᴅ {app.me.mention} Iɴ Gʀᴏᴜᴘs/Cʜᴀɴɴᴇʟs Aɴᴅ Mᴀᴋᴇ Aᴅᴍɪɴ Wɪᴛʜ Iɴᴠɪᴛᴇ Usᴇʀs Vɪᴀ Lɪɴᴋ Rɪɢʜᴛs.",
...
async def fcast(_, m : Message):
    ...
    await lel.edit(f"✅Successful Broadcasted to {success} users.\n❌ Failed to {failed} users.\n👾 Found {blocked} Blocked users \n👻 Found {deactivated} Deactivated users.")
